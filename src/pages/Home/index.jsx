...
import Futter from "../../components/Futtter";
...
export default function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div>
      <Toolbar />
      <Divider sx={{ marginTop: "-65px" }} className="rrr" />
      <List sx={{ backgroundColor: "#00CCCC", height: "180vh" }}>
        ...
        <nav className="tm-nav  mt-[120px]" id="tm-nav">
          <div className="px-[20px]">
            <div className="hover:border hover:border-white hover:w-[313px] w-[313px] border border-white h-[77px] pt-[10px]">
              <NavLink to={"/"} className="tm-nav-item pt-[-20px] ">
            ...
            <div className="h-[30px]"></div>
            <div className=" hover:w-[313px] w-[313px] hover:border hover:border-white h-[77px] pt-[10px]">
              <Link to={"/about"} className="tm-nav-item pt-[-20px] ">
                <a href="index.html" className="tm-nav-link">
        ...
        <div className="tm-social-links xl:grid xl:gap-1 lg:grid lg:grid-cols-4 md:grid md:grid-cols-4 grid grid-cols-4 px-[40px] xl:grid-cols-3 gap-3">
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Typography sx={{ width: "100%" }} paragraph>
          <div className="row tm-row tm-mb-75 xl:flex md:flex lg:flex mt-[200px] lg:px-[80px] mr-[40px] md:px-0 block ">
            <div className="tm-prev-next-wrapper xl:flex lg:block">
              <a
                href="#"
            ...
            <div className="tm-paging-wrapper xl:ml-[160px] lg:ml-[100px]">
          ...
          <div className=" md:w-[720px] lg:w-[600px] lg:ml-[30px] xl:w-[1000px]">
            <hr />
          </div>
